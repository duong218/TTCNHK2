    ...
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
            <div className='flex flex-col md:flex-row items-center justify-between w-full '>
                <Title align='left' title="Ưu đãi độc quyền" subTitle="Tận dụng các ưu đãi có thời hạn và các gói đặc biệt của chúng tôi để nâng cao trải nghiệm của bạn và tạo ra những kỷ niệm khó quên." />
