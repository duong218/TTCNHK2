...
const AllRooms = () => {
    ...
    const sortRooms = (a, b) => {
        ...
        if (selectedSort === 'Giá từ cao đến thấp') {
            return b.pricePerNight - a.pricePerNight;
        }
        if (selectedSort === 'Mới nhất trước') {
        ...
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
                ...
                <div className="flex flex-col items-start text-left">
                    ...
                    <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Tận dụng các ưu đãi có thời hạn và các gói đặc biệt của chúng tôi để nâng cao trải nghiệm của bạn và tạo ra những kỷ niệm khó quên.</p>
                </div>
            ...
            <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
                ...
                <div className={`${openFilters ? "h-auto" : "h-0 lg:h-auto"} overflow-hidden transition-all duration-700`}>
                    <div className='px-5 pt-5'>
                        <p className='font-medium text-gray-800 pb-2'>Phổ biến</p>
