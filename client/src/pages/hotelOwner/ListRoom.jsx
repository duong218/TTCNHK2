...
const ListRoom = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Danh sách phòng' subTitle='Xem, chỉnh sửa hoặc quản lý tất cả các phòng đã liệt kê. Cập nhật thông tin để mang lại trải nghiệm tốt nhất cho người dùng.' />
            <p className='text-gray-500 mt-8'>Tổng số khách sạn</p>
                ...
                <table className='w-full' >
                    <thead className='bg-gray-50 '>
                        <tr>
                            ...
                            <th className='py-3 px-4 text-gray-800 font-medium max-sm:hidden'>Cơ sở vật chất</th>
