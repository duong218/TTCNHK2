...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title='Đặt chỗ của tôi' subTitle='Dễ dàng quản lý các đặt phòng khách sạn trong quá khứ, hiện tại và tương lai của bạn tại một nơi. Lập kế hoạch chuyến đi của bạn một cách suôn sẻ chỉ với vài cú nhấp chuột.' align='left' />
                    ...
                    <div key={booking._id} className="grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t">
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                                ...
                                <p className="text-base">Tổng cộng: ${booking.totalPrice}</p>
                            </div>
                        </div>
